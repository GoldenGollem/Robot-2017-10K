 ...
 *
 */
public class RedCenterShoot extends Command {
    ...
    protected void initialize() {
    		...
    		if(GEARTARGET != null&&(Timer.getMatchTime()>0&&Timer.getMatchTime()<15)){
        	    ...
        	    while(GYRO.getAngle()>(-50)&&(Timer.getMatchTime()>0&&Timer.getMatchTime()<14.9)) DT.mecanumDrive_Cartesian(0, 0, -0.4, 0);
